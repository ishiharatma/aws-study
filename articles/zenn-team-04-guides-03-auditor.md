---
title: "TEAM for AWS IAM Identity Center 導入ガイド ──(6/6) ガイドライン(3)監査者向け" # 記事のタイトル
emoji: "🫂"
...
**セッションアクティビティ（Elevated access）**では、CloudTrail Lakeと連携して以下を追跡できます。
