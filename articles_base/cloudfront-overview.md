...
ログファイルは、2行のヘッダー（#Version と #Fields）が含まれたタブ区切りです。（[標準ログファイル形式](https://docs.aws.amazon.com/ja_jp/AmazonCloudFront/latest/DeveloperGuide/AccessLogs.html#LogFileFormat)）
