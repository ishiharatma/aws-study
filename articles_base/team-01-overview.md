...
![workflow](/images/team/workflow.png)
...
- CloudTrail Lake: セッションアクティビティログの保存（データ取り込みと保存期間に応じた課金）
  - 詳細は、「[CloudTrail Lakeのコスト管理](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-lake-manage-costs.html)」を参照してください
